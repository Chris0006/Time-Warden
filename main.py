...
# For Pyinstaller (in case of packaging)
import sys
...
# programs safe from Time Warden
excluded_programs = ["Task Manager", "Command Prompt", "Setup"]
...
while True:
    ...
    if current_program != last_program:
        ...
        if current_program not in running_pids:
            ...
            if len(program_name) > 0 and  program_name not in excluded_programs:
                    ...
                    try:
                        ...
                        class TimeEntryGUI:
                            def __init__(self, master):
                                self.master = master
                                master.title("Time Warden")
                                master.geometry("350x250")
                                master.configure(bg="#880808")
                                master.iconbitmap(resource_path("images/program_icon.ico"))
                                ...
                                if timer == 0: # cheatcode
                                    ...
                                    def end_process():
                                        ...
                                        class SessionExpiredGUI:
                                            def __init__(self, master):
                                                self.master = master
                                                master.title("Time Warden - Session Expired")
                                                master.geometry("350x250")
                                                master.configure(bg="#880808")
                                                master.iconbitmap(resource_path("images/program_icon.ico"))
                                                self.label_font = ("Arial", 12, "bold")
                                            ...
                                            def continue_session(self):
                                                ...
                                                file_name = resource_path("sounds/game_over.mp3") # Set the file name
